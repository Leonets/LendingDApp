...
echo TODO need to create a way to create OwnerRole, Xrd ResourceAddress and PackageAddress 

output=`resim call-function $lendingapp_package LendingDApp instantiate_lending_dapp 5 10 LND 1728 timebased 1000 none xrd lendingapp_package | awk '/Component: |Resource: / {print $NF}'`
